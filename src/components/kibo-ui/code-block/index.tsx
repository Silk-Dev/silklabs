...
type CodeBlockContextType = {
  ...
  onValueChange: ((value: unknown, _eventDetails: SelectRootChangeEventDetails) => void) | undefined;
  data: CodeBlockData[];
};
...
export type CodeBlockProps = HTMLAttributes<HTMLDivElement> & {
  defaultValue?: string;
  value?: string;
  onValueChange?: (value: string, _eventDetails: SelectRootChangeEventDetails) => void;
  data: CodeBlockData[];
};
...
export const CodeBlock = ({
  ...
  const handleContextValueChange = (newValue: unknown, _eventDetails: SelectRootChangeEventDetails) => {
    onValueChange(newValue as string);
  };

  return (
    <CodeBlockContext.Provider value={{ value, onValueChange: handleContextValueChange, data }}>
      <div
...
export const CodeBlockSelect = (props: CodeBlockSelectProps) => {
  ...
  const handleValueChange = (newValue: unknown, _eventDetails: SelectRootChangeEventDetails) => {
    if (onValueChange) {
      onValueChange(newValue as string, {
        reason: "none" as any,
        event: new Event("change"),
...
export type CodeBlockCopyButtonProps = Omit<ComponentProps<typeof Button>, "asChild"> & {
  asChild?: boolean;
  onCopy?: () => void;

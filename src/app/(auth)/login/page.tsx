      ...
      <div className="w-full max-w-sm border border-border-metal bg-gradient-to-b from-[rgba(42,48,60,0.88)] to-[rgba(25,33,34,0.96)] p-6 shadow-[0_18px_48px_rgba(0,0,0,0.24)]">
        ...
        <div>
          ...
          <div className="space-y-2 mb-4">
            <Button variant="outline" className="w-full gap-2" onClick={() => authClient.signIn.social("github")} disabled title="Coming Soon">
            ...
            <Button variant="outline" className="w-full gap-2" onClick={() => authClient.signIn.social("google")} disabled title="Coming Soon">
            ...
            <Button variant="outline" className="w-full gap-2" onClick={() => authClient.signIn.social("linkedin")} disabled={!linkedInEnabled} title={linkedInEnabled ? "" : "Coming Soon — configure LinkedIn OAuth in .env"}>
